...
LOG_NAME = "MClassifierLargePipelineUser100KRowsTrainEXTTimestampsCols30PercentRandAttackersRandOffset50000To100000"
...
class MClassifierLargePipelineUser100KRowsTrainEXTTimestampsCols30PercentRandAttackersRandOffset50000To100000:
    ...
    def run(self):
        ...
        train = DataAttacker(train,
                             modified_data_path=f"data/classifierdata/modified/{LOG_NAME}/modified_train.csv", SEED=24, logger=self.logger.newPrefix("DataAttacker")).add_rand_attackers(attack_ratio=0.3).add_attacks_positional_offset_rand(min_dist=50000, max_dist=100000).getData()
        test = DataAttacker(test,
                            modified_data_path=f"data/classifierdata/modified/{LOG_NAME}/modified_test.csv", SEED=48, logger=self.logger.newPrefix("DataAttacker")).add_rand_attackers(attack_ratio=0.3).add_attacks_positional_offset_rand(min_dist=50000, max_dist=100000).getData()
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUser100KRowsTrainEXTTimestampsCols30PercentRandAttackersRandOffset50000To100000()
    mcplu.run()
