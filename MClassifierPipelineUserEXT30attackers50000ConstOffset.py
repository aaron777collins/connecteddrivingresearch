...
LOG_NAME = "MClassifierPipelineUserEXT30attackers50000ConstOffset"
...
class MClassifierPipelineUserEXT30attackers50000ConstOffset:
...
if __name__ == "__main__":
    mcplu = MClassifierPipelineUserEXT30attackers50000ConstOffset()
    mcplu.run()
