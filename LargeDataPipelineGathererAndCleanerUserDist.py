...
LOG_NAME = "LargeDataPipelineGathererAndCleanerUserDist"
...
class LargeDataPipelineGathererAndCleanerUserDist:
    ...
    def run(self, cleanFunc=DataCleaner.clean_data_with_timestamps, filterFunction=LargeDataCleaner.within_range, max_dist=100, x_col="x_pos", y_col="y_pos", x_pos=-105.1159611, y_pos=41.0982327, lines_per_file=100000):
        ...
        self.dc.clean_data(filterFunction=filterFunction, cleanFunc=cleanFunc, max_dist=max_dist, x_col=x_col, y_col=y_pos, x_pos=x_pos, y_pos=y_pos)
...
if __name__ == "__main__":
    mcplu = LargeDataPipelineGathererAndCleanerUserDist()
    mcplu.run()
