...
LOG_NAME = "LargeDataPipelineGathererUser"
...
class LargeDataPipelineGathererUser:
    ...
    def run(self):
        ...
        dc = LargeDataCleaner(splitfilespath=f"data/classifierdata/split/{LOG_NAME}/split/", cleanedsplitfilespath=f"data/clean/{LOG_NAME}/split/", combinedcleandatapath=f"data/clean/{LOG_NAME}/combined.csv", logger=self.logger.newPrefix("LargeDataCleaner"))
...
if __name__ == "__main__":
    mcplu = LargeDataPipelineGathererUser()
    mcplu.run()
