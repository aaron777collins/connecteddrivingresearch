...
LOG_NAME = "MClassifierPipelineUserEXTCols30attackersRandOffset50000To100000"
...
class MClassifierPipelineUserEXTCols30attackersRandOffset50000To100000:
    ...
    def run(self):
        ...
        mdcleaner_train = MDataCleaner(train, cleandatapath=f"data/classifierdata/Mclean/{LOG_NAME}/clean_train.csv", columns=COLUMNS_EXT, logger=self.logger.newPrefix("MDataCleaner"))
        mdcleaner_test = MDataCleaner(test, cleandatapath=f"data/classifierdata/Mclean/{LOG_NAME}/clean_test.csv", columns=COLUMNS_EXT, logger=self.logger.newPrefix("MDataCleaner"))
...
if __name__ == "__main__":
    mcplu = MClassifierPipelineUserEXTCols30attackersRandOffset50000To100000()
    mcplu.run()
