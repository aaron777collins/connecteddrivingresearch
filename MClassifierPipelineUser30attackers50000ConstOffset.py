...
LOG_NAME = "MClassifierPipelineUser30attackers50000ConstOffset"
...
class MClassifierPipelineUser30attackers50000ConstOffset:
...
if __name__ == "__main__":
    mcplu = MClassifierPipelineUser30attackers50000ConstOffset()
    mcplu.run()
